...
//        }
    ...
    private ResultUtil<?> loginResponseObject(Throwable ex) {
        ...
        if(customException == null) {
            SysCmsUtils.log.info("未知异常捕获统一返回==================");
            return ResultUtil.failed(ResultEnum.OAuth2Exception);
        }
...
//            jgen.writeNumberField("code",ResultEnum.OAUTH2_UNSUPPORTED_GRANT_TYPE.getCode());
//            jgen.writeStringField("message",ResultEnum.OAUTH2_UNSUPPORTED_GRANT_TYPE.getMessage());
//        }
        // 非授权范围响应
