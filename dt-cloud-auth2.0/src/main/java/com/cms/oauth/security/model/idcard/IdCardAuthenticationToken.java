...
/**
 * @author DT辰白 Created by 2022/4/28 13:09
 */
public class IdCardAuthenticationToken extends AbstractAuthenticationToken {
    ...
    public IdCardAuthenticationToken(Object principal, Object credentials, Collection<? extends GrantedAuthority> authorities) {
        super(authorities);
        this.principal = principal;
        this.credentials = credentials;
