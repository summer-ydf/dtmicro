...
public class OlapRabbitMqServiceImpl implements OlapRabbitMqService {
    ...
    public void sendLoginLog(HttpServletRequest request, SecurityClaimsUser securityClaimsUser, boolean flag) {
        ...
        SysLoginLogVo buildObject = SysLoginLogVo.builder()
                ...
                .build();
        // RabbitMQ消息推送
        rabbitTemplate.convertAndSend(ConstantCommonCode.RABBITMQ_EXCHANGE_LOG, ConstantCommonCode.RABBITMQ_TOPIC_LOG, buildObject);
        //rabbitTemplate.convertAndSend("noo", ConstantCommonCode.RABBITMQ_TOPIC_LOG, buildObject);
    }
}
